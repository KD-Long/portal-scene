...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function qc(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:hl(),fragmentShader:`
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function jc(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hl(),fragmentShader:`
...
}`;function Hn(s){if(s===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return s}function qh(s,e){s.prototype=Object.create(e.prototype),s.prototype.constructor=s,s.__proto__=e}/*!
 * GSAP 3.12.2
 * https://greensock.com
 *
 ...
 * Club GreenSock members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var Yu,li,br,Ul,Ui,qu,Nl,$y=function(){return typeof window<"u"},Zn={},Pi=180/Math.PI,Ar=Math.PI/180,gr=Math.atan2,ju=1e8,Ol=/([A-Z])/g,Zy=/(left|right|width|margin|padding|x)/i,Jy=/[\s,\(]\S/,Sn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},tl=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},Qy=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},eM=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},tM=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},Nd=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},Od=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},nM=function(e,t,n){return e.style[t]=n},iM=function(e,t,n){return e.style.setProperty(t,n)},rM=function(e,t,n){return e._gsap[t]=n},sM=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},aM=function(e,t,n,i,r){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(r,a)},oM=function(e,t,n,i,r){var a=e._gsap;a[t]=n,a.renderTransform(r,a)},Qe="transform",mn=Qe+"Origin",lM=function s(e,t){var n=this,i=this.target,r=i.style;if(e in Zn&&r){if(this.tfm=this.tfm||{},e!=="transform")e=Sn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(a){return n.tfm[a]=Gn(i,a)}):this.tfm[e]=i._gsap.x?i._gsap[e]:Gn(i,e);else return Sn.transform.split(",").forEach(function(a){return s.call(n,a,t)});if(this.props.indexOf(Qe)>=0)return;i._gsap.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(mn,t,"")),e=Qe}(r||t)&&this.props.push(e,t,r[e])},Fd=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},cM=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,r,a;for(r=0;r<e.length;r+=3)e[r+1]?t[e[r]]=e[r+2]:e[r+2]?n[e[r]]=e[r+2]:n.removeProperty(e[r].substr(0,2)==="--"?e[r]:e[r].replace(Ol,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),r=Nl(),(!r||!r.isStart)&&!n[Qe]&&(Fd(n),i.uncache=1)}},Bd=function(e,t){var n={target:e,props:[],revert:cM,save:lM};return e._gsap||Ht.core.getCache(e),t&&t.split(",").forEach(function(i){return n.save(i)}),n},kd,nl=function(e,t){var n=li.createElementNS?li.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):li.createElement(e);return n.style?n:li.createElement(e)},bn=function s(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(Ol,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&s(e,kr(t)||t,1)||""},Ku="O,Moz,ms,Ms,Webkit".split(","),kr=function(e,t,n){var i=t||Ui,r=i.style,a=5;if(e in r&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Ku[a]+e in r););return a<0?null:(a===3?"ms":a>=0?Ku[a]:"")+e},il=function(){$y()&&window.document&&(Yu=window,li=Yu.document,br=li.documentElement,Ui=nl("div")||{style:{}},nl("div"),Qe=kr(Qe),mn=Qe+"Origin",Ui.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",kd=!!kr("perspective"),Nl=Ht.core.reverting,Ul=1)},wo=function s(e){var t=nl("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,r=this.style.cssText,a;if(br.appendChild(t),t.appendChild(this),this.style.display="block",e)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=s}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),br.removeChild(t),this.style.cssText=r,a},$u=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},zd=function(e){var t;try{t=e.getBBox()}catch{t=wo.call(e,!0)}return t&&(t.width||t.height)||e.getBBox===wo||(t=wo.call(e,!0)),t&&!t.width&&!t.x&&!t.y?{x:+$u(e,["x","cx","x1"])||0,y:+$u(e,["y","cy","y1"])||0,width:0,height:0}:t},Hd=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&zd(e))},ys=function(e,t){if(t){var n=e.style;t in Zn&&t!==mn&&(t=Qe),n.removeProperty?((t.substr(0,2)==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(t.replace(Ol,"-$1").toLowerCase())):n.removeAttribute(t)}},ci=function(e,t,n,i,r,a){var o=new zt(e._pt,t,n,0,1,a?Od:Nd);return e._pt=o,o.b=i,o.e=r,e._props.push(n),o},Zu={deg:1,rad:1,turn:1},uM={grid:1,flex:1},mi=function s(e,t,n,i){var r=parseFloat(n)||0,a=(n+"").trim().substr((r+"").length)||"px",o=Ui.style,l=Zy.test(t),c=e.tagName.toLowerCase()==="svg",u=(c?"client":"offset")+(l?"Width":"Height"),h=100,d=i==="px",p=i==="%",_,g,m,f;return i===a||!r||Zu[i]||Zu[a]?r:(a!=="px"&&!d&&(r=s(e,t,n,"px")),f=e.getCTM&&Hd(e),(p||a==="%")&&(Zn[t]||~t.indexOf("adius"))?(_=f?e.getBBox()[l?"width":"height"]:e[u],ot(p?r/_*h:r/100*_)):(o[l?"width":"height"]=h+(d?a:i),g=~t.indexOf("adius")||i==="em"&&e.appendChild&&!c?e:e.parentNode,f&&(g=(e.ownerSVGElement||{}).parentNode),(!g||g===li||!g.appendChild)&&(g=li.body),m=g._gsap,m&&p&&m.width&&l&&m.time===Yt.time&&!m.uncache?ot(r/m.width*h):((p||a==="%")&&!uM[bn(g,"display")]&&(o.position=bn(e,"position")),g===e&&(o.position="static"),g.appendChild(Ui),_=Ui[u],g.removeChild(Ui),o.position="absolute",l&&p&&(m=ki(g),m.time=Yt.time,m.width=g[u]),ot(d?_*r/h:_&&r?h/_*r:0))))},Gn=function(e,t,n,i){var r;return Ul||il(),t in Sn&&t!=="transform"&&(t=Sn[t],~t.indexOf(",")&&(t=t.split(",")[0])),Zn[t]&&t!=="transform"?(r=Ss(e,i),r=t!=="transformOrigin"?r[t]:r.svg?r.origin:xa(bn(e,mn))+" "+r.zOrigin+"px"):(r=e.style[t],(!r||r==="auto"||i||~(r+"").indexOf("calc("))&&(r=_a[t]&&_a[t](e,t,n)||bn(e,t)||id(e,t)||(t==="opacity"?1:0))),n&&!~(r+"").trim().indexOf(" ")?mi(e,t,r,n)+n:r},hM=function(e,t,n,i){if(!n||n==="none"){var r=kr(t,e,1),a=r&&bn(e,r,1);a&&a!==n?(t=r,n=a):t==="borderColor"&&(n=bn(e,"borderTopColor"))}var o=new zt(this._pt,e.style,t,0,1,Dd),l=0,c=0,u,h,d,p,_,g,m,f,v,x,M,S;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(e.style[t]=i,i=bn(e,t)||i,e.style[t]=n),u=[n,i],Sd(u),n=u[0],i=u[1],d=n.match(vr)||[],S=i.match(vr)||[],S.length){for(;h=vr.exec(i);)m=h[0],v=i.substring(l,h.index),_?_=(_+1)%5:(v.substr(-5)==="rgba("||v.substr(-5)==="hsla(")&&(_=1),m!==(g=d[c++]||"")&&(p=parseFloat(g)||0,M=g.substr((p+"").length),m.charAt(1)==="="&&(m=Tr(p,m)+M),f=parseFloat(m),x=m.substr((f+"").length),l=vr.lastIndex-x.length,x||(x=x||jt.units[t]||M,l===i.length&&(i+=x,o.e+=x)),M!==x&&(p=mi(e,t,g,x)||0),o._pt={_next:o._pt,p:v||c===1?v:",",s:p,c:f-p,m:_&&_<4||t==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=t==="display"&&i==="none"?Od:Nd;return Zh.test(i)&&(o.e=0),this._pt=o,o},Ju={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},dM=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Ju[n]||n,t[1]=Ju[i]||i,t.join(" ")},fM=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,r=t.u,a=n._gsap,o,l,c;if(r==="all"||r===!0)i.cssText="",l=1;else for(r=r.split(","),c=r.length;--c>-1;)o=r[c],Zn[o]&&(l=1,o=o==="transformOrigin"?mn:Qe),ys(n,o);l&&(ys(n,Qe),a&&(a.svg&&n.removeAttribute("transform"),Ss(n,1),a.uncache=1,Fd(i)))}},_a={clearProps:function(e,t,n,i,r){if(r.data!=="isFromStart"){var a=e._pt=new zt(e._pt,t,n,0,0,fM);return a.u=i,a.pr=-10,a.tween=r,e._props.push(n),1}}},Ms=[1,0,0,1,0,0],Gd={},Vd=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Qu=function(e){var t=bn(e,Qe);return Vd(t)?Ms:t.substr(7).match($h).map(ot)},Fl=function(e,t){var n=e._gsap||ki(e),i=e.style,r=Qu(e),a,o,l,c;return n.svg&&e.getAttribute("transform")?(l=e.transform.baseVal.consolidate().matrix,r=[l.a,l.b,l.c,l.d,l.e,l.f],r.join(",")==="1,0,0,1,0,0"?Ms:r):(r===Ms&&!e.offsetParent&&e!==br&&!n.svg&&(l=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent)&&(c=1,o=e.nextElementSibling,br.appendChild(e)),r=Qu(e),l?i.display=l:ys(e,"display"),c&&(o?a.insertBefore(e,o):a?a.appendChild(e):br.removeChild(e))),t&&r.length>6?[r[0],r[1],r[4],r[5],r[12],r[13]]:r)},rl=function(e,t,n,i,r,a){var o=e._gsap,l=r||Fl(e,!0),c=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,d=o.yOffset||0,p=l[0],_=l[1],g=l[2],m=l[3],f=l[4],v=l[5],x=t.split(" "),M=parseFloat(x[0])||0,S=parseFloat(x[1])||0,b,R,L,y;n?l!==Ms&&(R=p*m-_*g)&&(L=M*(m/R)+S*(-g/R)+(g*v-m*f)/R,y=M*(-_/R)+S*(p/R)-(p*v-_*f)/R,M=L,S=y):(b=zd(e),M=b.x+(~x[0].indexOf("%")?M/100*b.width:M),S=b.y+(~(x[1]||x[0]).indexOf("%")?S/100*b.height:S)),i||i!==!1&&o.smooth?(f=M-c,v=S-u,o.xOffset=h+(f*p+v*g)-f,o.yOffset=d+(f*_+v*m)-v):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=S,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[mn]="0px 0px",a&&(ci(a,o,"xOrigin",c,M),ci(a,o,"yOrigin",u,S),ci(a,o,"xOffset",h,o.xOffset),ci(a,o,"yOffset",d,o.yOffset)),e.setAttribute("data-svg-origin",M+" "+S)},Ss=function(e,t){var n=e._gsap||new Ad(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,r=n.scaleX<0,a="px",o="deg",l=getComputedStyle(e),c=bn(e,mn)||"0",u,h,d,p,_,g,m,f,v,x,M,S,b,R,L,y,A,z,j,I,F,N,K,H,W,Q,$,de,O,ee,J,ae;return u=h=d=g=m=f=v=x=M=0,p=_=1,n.svg=!!(e.getCTM&&Hd(e)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[Qe]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[Qe]!=="none"?l[Qe]:"")),i.scale=i.rotate=i.translate="none"),R=Fl(e,n.svg),n.svg&&(n.uncache?(W=e.getBBox(),c=n.xOrigin-W.x+"px "+(n.yOrigin-W.y)+"px",H=""):H=!t&&e.getAttribute("data-svg-origin"),rl(e,H||c,!!H||n.originIsAbsolute,n.smooth!==!1,R)),S=n.xOrigin||0,b=n.yOrigin||0,R!==Ms&&(z=R[0],j=R[1],I=R[2],F=R[3],u=N=R[4],h=K=R[5],R.length===6?(p=Math.sqrt(z*z+j*j),_=Math.sqrt(F*F+I*I),g=z||j?gr(j,z)*Pi:0,v=I||F?gr(I,F)*Pi+g:0,v&&(_*=Math.abs(Math.cos(v*Ar))),n.svg&&(u-=S-(S*z+b*I),h-=b-(S*j+b*F))):(ae=R[6],ee=R[7],$=R[8],de=R[9],O=R[10],J=R[11],u=R[12],h=R[13],d=R[14],L=gr(ae,O),m=L*Pi,L&&(y=Math.cos(-L),A=Math.sin(-L),H=N*y+$*A,W=K*y+de*A,Q=ae*y+O*A,$=N*-A+$*y,de=K*-A+de*y,O=ae*-A+O*y,J=ee*-A+J*y,N=H,K=W,ae=Q),L=gr(-I,O),f=L*Pi,L&&(y=Math.cos(-L),A=Math.sin(-L),H=z*y-$*A,W=j*y-de*A,Q=I*y-O*A,J=F*A+J*y,z=H,j=W,I=Q),L=gr(j,z),g=L*Pi,L&&(y=Math.cos(L),A=Math.sin(L),H=z*y+j*A,W=N*y+K*A,j=j*y-z*A,K=K*y-N*A,z=H,N=W),m&&Math.abs(m)+Math.abs(g)>359.9&&(m=g=0,f=180-f),p=ot(Math.sqrt(z*z+j*j+I*I)),_=ot(Math.sqrt(K*K+ae*ae)),L=gr(N,K),v=Math.abs(L)>2e-4?L*Pi:0,M=J?1/(J<0?-J:J):0),n.svg&&(H=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!Vd(bn(e,Qe)),H&&e.setAttribute("transform",H))),Math.abs(v)>90&&Math.abs(v)<270&&(r?(p*=-1,v+=g<=0?180:-180,g+=g<=0?180:-180):(_*=-1,v+=v<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=d+a,n.scaleX=ot(p),n.scaleY=ot(_),n.rotation=ot(g)+o,n.rotationX=ot(m)+o,n.rotationY=ot(f)+o,n.skewX=v+o,n.skewY=x+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(c.split(" ")[2])||0)&&(i[mn]=xa(c)),n.xOffset=n.yOffset=0,n.force3D=jt.force3D,n.renderTransform=n.svg?mM:kd?Wd:pM,n.uncache=0,n},xa=function(e){return(e=e.split(" "))[0]+" "+e[1]},Ro=function(e,t,n){var i=wt(t);return ot(parseFloat(t)+parseFloat(mi(e,"x",n+"px",i)))+i},pM=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,Wd(e,t)},wi="0deg",es="0px",Ri=") ",Wd=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,u=n.rotationY,h=n.rotationX,d=n.skewX,p=n.skewY,_=n.scaleX,g=n.scaleY,m=n.transformPerspective,f=n.force3D,v=n.target,x=n.zOrigin,M="",S=f==="auto"&&e&&e!==1||f===!0;if(x&&(h!==wi||u!==wi)){var b=parseFloat(u)*Ar,R=Math.sin(b),L=Math.cos(b),y;b=parseFloat(h)*Ar,y=Math.cos(b),a=Ro(v,a,R*y*-x),o=Ro(v,o,-Math.sin(b)*-x),l=Ro(v,l,L*y*-x+x)}m!==es&&(M+="perspective("+m+Ri),(i||r)&&(M+="translate("+i+"%, "+r+"%) "),(S||a!==es||o!==es||l!==es)&&(M+=l!==es||S?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Ri),c!==wi&&(M+="rotate("+c+Ri),u!==wi&&(M+="rotateY("+u+Ri),h!==wi&&(M+="rotateX("+h+Ri),(d!==wi||p!==wi)&&(M+="skew("+d+", "+p+Ri),(_!==1||g!==1)&&(M+="scale("+_+", "+g+Ri),v.style[Qe]=M||"translate(0, 0)"},mM=function(e,t){var n=t||this,i=n.xPercent,r=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,u=n.skewY,h=n.scaleX,d=n.scaleY,p=n.target,_=n.xOrigin,g=n.yOrigin,m=n.xOffset,f=n.yOffset,v=n.forceCSS,x=parseFloat(a),M=parseFloat(o),S,b,R,L,y;l=parseFloat(l),c=parseFloat(c),u=parseFloat(u),u&&(u=parseFloat(u),c+=u,l+=u),l||c?(l*=Ar,c*=Ar,S=Math.cos(l)*h,b=Math.sin(l)*h,R=Math.sin(l-c)*-d,L=Math.cos(l-c)*d,c&&(u*=Ar,y=Math.tan(c-u),y=Math.sqrt(1+y*y),R*=y,L*=y,u&&(y=Math.tan(u),y=Math.sqrt(1+y*y),S*=y,b*=y)),S=ot(S),b=ot(b),R=ot(R),L=ot(L)):(S=h,L=d,b=R=0),(x&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(x=mi(p,"x",a,"px"),M=mi(p,"y",o,"px")),(_||g||m||f)&&(x=ot(x+_-(_*S+g*R)+m),M=ot(M+g-(_*b+g*L)+f)),(i||r)&&(y=p.getBBox(),x=ot(x+i/100*y.width),M=ot(M+r/100*y.height)),y="matrix("+S+","+b+","+R+","+L+","+x+","+M+")",p.setAttribute("transform",y),v&&(p.style[Qe]=y)},gM=function(e,t,n,i,r){var a=360,o=Mt(r),l=parseFloat(r)*(o&&~r.indexOf("rad")?Pi:1),c=l-i,u=i+c+"deg",h,d;return o&&(h=r.split("_")[1],h==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),h==="cw"&&c<0?c=(c+a*ju)%a-~~(c/a)*a:h==="ccw"&&c>0&&(c=(c-a*ju)%a-~~(c/a)*a)),e._pt=d=new zt(e._pt,t,n,i,c,Qy),d.e=u,d.u="deg",e._props.push(n),d},eh=function(e,t){for(var n in t)e[n]=t[n];return e},_M=function(e,t,n){var i=eh({},n._gsap),r="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,u,h,d,p,_;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[Qe]=t,o=Ss(n,1),ys(n,Qe),n.setAttribute("transform",c)):(c=getComputedStyle(n)[Qe],a[Qe]=t,o=Ss(n,1),a[Qe]=c);for(l in Zn)c=i[l],u=o[l],c!==u&&r.indexOf(l)<0&&(p=wt(c),_=wt(u),h=p!==_?mi(n,l,c,_):parseFloat(c),d=parseFloat(u),e._pt=new zt(e._pt,o,l,h,d-h,tl),e._pt.u=_||0,e._props.push(l));eh(o,i)};kt("padding,margin,Width,Radius",function(s,e){var t="Top",n="Right",i="Bottom",r="Left",a=(e<3?[t,n,i,r]:[t+r,t+n,i+n,i+r]).map(function(o){return e<2?s+o:"border"+o+s});_a[e>1?"border"+s:s]=function(o,l,c,u,h){var d,p;if(arguments.length<4)return d=a.map(function(_){return Gn(o,_,c)}),p=d.join(" "),p.split(d[0]).length===5?d[0]:p;d=(u+"").split(" "),p={},a.forEach(function(_,g){return p[_]=d[g]=d[g]||d[(g-1)/2|0]}),o.init(l,p,h)}});var Xd={name:"css",register:il,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,r){var a=this._props,o=e.style,l=n.vars.startAt,c,u,h,d,p,_,g,m,f,v,x,M,S,b,R,L;Ul||il(),this.styles=this.styles||Bd(e),L=this.styles.props,this.tween=n;for(g in t)if(g!=="autoRound"&&(u=t[g],!(Xt[g]&&wd(g,t,n,i,e,r)))){if(p=typeof u,_=_a[g],p==="function"&&(u=u.call(n,i,e,r),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=_s(u)),_)_(this,e,g,u,n)&&(R=1);else if(g.substr(0,2)==="--")c=(getComputedStyle(e).getPropertyValue(g)+"").trim(),u+="",fi.lastIndex=0,fi.test(c)||(m=wt(c),f=wt(u)),f?m!==f&&(c=mi(e,g,c,f)+f):m&&(u+=m),this.add(o,"setProperty",c,u,i,r,0,0,g),a.push(g),L.push(g,0,o[g]);else if(p!=="undefined"){if(l&&g in l?(c=typeof l[g]=="function"?l[g].call(n,i,e,r):l[g],Mt(c)&&~c.indexOf("random(")&&(c=_s(c)),wt(c+"")||(c+=jt.units[g]||wt(Gn(e,g))||""),(c+"").charAt(1)==="="&&(c=Gn(e,g))):c=Gn(e,g),d=parseFloat(c),v=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),v&&(u=u.substr(2)),h=parseFloat(u),g in Sn&&(g==="autoAlpha"&&(d===1&&Gn(e,"visibility")==="hidden"&&h&&(d=0),L.push("visibility",0,o.visibility),ci(this,o,"visibility",d?"inherit":"hidden",h?"inherit":"hidden",!h)),g!=="scale"&&g!=="transform"&&(g=Sn[g],~g.indexOf(",")&&(g=g.split(",")[0]))),x=g in Zn,x){if(this.styles.save(g),M||(S=e._gsap,S.renderTransform&&!t.parseTransform||Ss(e,t.parseTransform),b=t.smoothOrigin!==!1&&S.smooth,M=this._pt=new zt(this._pt,o,Qe,0,1,S.renderTransform,S,0,-1),M.dep=1),g==="scale")this._pt=new zt(this._pt,S,"scaleY",S.scaleY,(v?Tr(S.scaleY,v+h):h)-S.scaleY||0,tl),this._pt.u=0,a.push("scaleY",g),g+="X";else if(g==="transformOrigin"){L.push(mn,0,o[mn]),u=dM(u),S.svg?rl(e,u,0,b,0,this):(f=parseFloat(u.split(" ")[2])||0,f!==S.zOrigin&&ci(this,S,"zOrigin",S.zOrigin,f),ci(this,o,g,xa(c),xa(u)));continue}else if(g==="svgOrigin"){rl(e,u,1,b,0,this);continue}else if(g in Gd){gM(this,S,g,d,v?Tr(d,v+u):u);continue}else if(g==="smoothOrigin"){ci(this,S,"smooth",S.smooth,u);continue}else if(g==="force3D"){S[g]=u;continue}else if(g==="transform"){_M(this,u,e);continue}}else g in o||(g=kr(g)||g);if(x||(h||h===0)&&(d||d===0)&&!Jy.test(u)&&g in o)m=(c+"").substr((d+"").length),h||(h=0),f=wt(u)||(g in jt.units?jt.units[g]:m),m!==f&&(d=mi(e,g,c,f)),this._pt=new zt(this._pt,x?S:o,g,d,(v?Tr(d,v+h):h)-d,!x&&(f==="px"||g==="zIndex")&&t.autoRound!==!1?tM:tl),this._pt.u=f||0,m!==f&&f!=="%"&&(this._pt.b=c,this._pt.r=eM);else if(g in o)hM.call(this,e,g,c,v?v+u:u);else if(g in e)this.add(e,g,c||e[g],v?v+u:u,i,r);else if(g!=="parseTransform"){bl(g,u);continue}x||(g in o?L.push(g,0,o[g]):L.push(g,1,c||e[g])),a.push(g)}}R&&Id(this)},render:function(e,t){if(t.tween._time||!Nl())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Gn,aliases:Sn,getSetter:function(e,t,n){var i=Sn[t];return i&&i.indexOf(",")<0&&(t=i),t in Zn&&t!==mn&&(e._gsap.x||Gn(e,"x"))?n&&qu===n?t==="scale"?sM:rM:(qu=n||{})&&(t==="scale"?aM:oM):e.style&&!Sl(e.style[t])?nM:~t.indexOf("-")?iM:Dl(e,t)},core:{_removeProperty:ys,_getMatrix:Fl}};Ht.utils.checkPrefix=kr;Ht.core.getStyleSaver=Bd;(function(s,e,t,n){var i=kt(s+","+e+","+t,function(r){Zn[r]=1});kt(e,function(r){jt.units[r]="deg",Gd[r]=1}),Sn[i[13]]=s+","+e,kt(n,function(r){var a=r.split(":");Sn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");kt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(s){jt.units[s]="px"});Ht.registerPlugin(Xd);var Yd=Ht.registerPlugin(Xd)||Ht;Yd.core.Tween;const wa=new sl({width:400}),Cn={clearColor:2103577,portalColorStart:2094,portalColorEnd:13761535},qd=document.querySelector("canvas.webgl"),Wr=new Ux,jd=document.querySelector(".loading-bar"),As=new Vh;As.onLoad=()=>{console.log("loaded"),window.setTimeout(()=>{Yd.to(Kd.uniforms.uAlpha,{duration:2,value:0}),jd.style.display="none"},1e3)};As.onProgress=(s,e,t)=>{const n=e/t;jd.style.transform=`scaleX(${n})`};const xM=new Sa(2,2,1,1),Kd=new wn({transparent:!0,uniforms:{uAlpha:{value:1},uLoadingColor:{value:new Te(Cn.portalColorStart)}},vertexShader:`
    void main(){
        gl_Position = vec4(position, 1.0);
    }
    `,fragmentShader:`
    ...
    `}),vM=new qt(xM,Kd);Wr.add(vM);const yM=new Wh(As),Bl=yM.load("baked.jpg");Bl.flipY=!1;Bl.colorSpace=Me;const $d=new Jv(As);$d.setDecoderPath("draco/");const Zd=new vv(As);Zd.load("my_portal.glb",s=>{const e=s.scene.children.find(r=>r.name==="baked");e.material=MM;const t=s.scene.children.find(r=>r.name==="plight1"),n=s.scene.children.find(r=>r.name==="plight2"),i=s.scene.children.find(r=>r.name==="portalLight");t.material=th,n.material=th,i.material=Ca,Wr.add(s.scene)});Zd.setDRACOLoader($d);const MM=new Yn({map:Bl}),th=new Yn({color:16777189}),kl=new on,zl=30,aa=new Float32Array(zl*3),Jd=new Float32Array(zl);for(let s=0;s<zl;s++)aa[s*3+0]=(Math.random()-.5)*4,aa[s*3+1]=Math.random()*1.5,aa[s*3+2]=(Math.random()-.5)*4,Jd[s]=Math.random();kl.setAttribute("position",new pt(aa,3));kl.setAttribute("aScale",new pt(Jd,1));const Ra=new wn({transparent:!0,blending:Lo,depthWrite:!1,vertexShader:ey,fragmentShader:ty,uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)},uSize:{value:180}}}),SM=new kh(kl,Ra);Wr.add(SM);const Ca=new wn({vertexShader:ny,fragmentShader:iy,uniforms:{uTime:{value:0},uPixelRatio:{value:Math.min(window.devicePixelRatio,2)},uColorStart:{value:new Te(Cn.portalColorStart)},uColorEnd:{value:new Te(Cn.portalColorEnd)}}}),EM=new dl(2500663,3,10);Wr.fog=EM;const vn={width:window.innerWidth,height:window.innerHeight};window.addEventListener("resize",()=>{vn.width=window.innerWidth,vn.height=window.innerHeight,gi.aspect=vn.width/vn.height,gi.updateProjectionMatrix(),qi.setSize(vn.width,vn.height),qi.setPixelRatio(Math.min(window.devicePixelRatio,2)),Ra.uniforms.uPixelRatio.value=Math.min(window.devicePixelRatio,2)});const gi=new Ut(45,vn.width/vn.height,.1,100);gi.position.x=4;gi.position.y=2;gi.position.z=4;Wr.add(gi);const Qd=new xv(gi,qd);Qd.enableDamping=!0;wa.addColor(Cn,"clearColor").onChange(()=>{qi.setClearColor(Cn.clearColor)});wa.addColor(Cn,"portalColorStart").onChange(()=>{Ca.uniforms.uColorStart.value=new Te(Cn.portalColorStart)});wa.addColor(Cn,"portalColorEnd").onChange(()=>{Ca.uniforms.uColorEnd.value=new Te(Cn.portalColorEnd)});wa.add(Ra.uniforms.uSize,"value",0,500,1).name("ffSize");const qi=new Nh({canvas:qd,antialias:!0});qi.setSize(vn.width,vn.height);qi.setPixelRatio(Math.min(window.devicePixelRatio,2));qi.setClearColor(Cn.clearColor);const TM=new lv,ef=()=>{const s=TM.getElapsedTime();Ra.uniforms.uTime.value=s,Ca.uniforms.uTime.value=s,Qd.update(),qi.render(Wr,gi),window.requestAnimationFrame(ef)};ef();
//# sourceMappingURL=index-2fb2683f.js.map
